 ...
 */
public class BrisanjeZadatka  extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brisanje_zad);
    ...
    public void onClick(View v) {
        if (v.getId() == (R.id.button_delete_yes)) {
            StringRequest stringRequest = new StringRequest(
                    Request.Method.POST,
                    "http://whackamile.byethost3.com/taskme/taskmeZadatakBrisanje.php",
                    new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
                            Toast.makeText(BrisanjeZadatka.this, response, Toast.LENGTH_LONG).show();
            ...
            Intent mado = new Intent(BrisanjeZadatka.this, PretragaZadataka.class);
            startActivity(mado);
        }
    }
